...
<div class="container">
    ...
    <div class="btn-group btn-group-justified">
      <div class="btn-group">
        ...
        <div class="btn-group">
      <a href="./homepage3.php" class="btn btn-primary" >Sort By</a>
    </div>
    <div class="btn-group">
      <button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-log-in"></span>Name</button>
    </div>
    <div class="btn-group">
      <a href="login.php" class="btn btn-primary"><span class="glyphicon glyphicon-log-out"></span>Logout</a>
    </div>
...
<?php
$sql = "select title , description, read_more,update_date from news_article LIMIT 6;";
